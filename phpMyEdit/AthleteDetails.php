...
class Example1 extends Common
{
	...
	{
		$tableColumns['MembershipID'] = array('display_text' => 'ID', 'perms' => 'TVQSXO');
		$tableColumns['FirstName'] = array('display_text' => 'First Name', 'perms' => 'EVCTAXQSHO');
		$tableColumns['MiddleInitial'] = array('display_text' => 'M I', 'perms' => 'EVCTAXQSHO');
		...
		$tableColumns['GID'] = array('display_text' => 'Guardian', 'perms' => 'EVCTAXQSHO', 'join' => array('table' => 'Guardian', 'column' => 'GID', 'display_mask' => "concat(Guardian.FirstName,' ',Guardian.Surname)", 'type' => 'left'));
		$tableColumns['RelID'] = array('display_text' => 'Relation', 'perms' => 'EVCTAXQSHO', 'join' => array('table' => 'AtRelToGuard', 'column' => 'RelID', 'display_mask' => "concat(AtRelToGuard.RelKind)", 'type' => 'left'));
		...
		$this->Editor->setConfig('orderByColumn','Surname');
