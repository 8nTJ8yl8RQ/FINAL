...
<!--      <div class="logo">
      ...
      <div class="menu_nav">
        <ul>
         ...
         <li><a href="AtRelToGuard1.php">Coach</a></li>
        </ul>
      </div>
      <div class="clr"></div>
    </div>
  </div>
	<h3 align=center>Squad Member Details</h3> 
<?php
...
$opts['pw'] = 'n4UVFpHeHr';
$opts['db'] = 'bulilit';
$opts['tb'] = 'SquadMemDetails';

// Name of field which is the unique key
$opts['key'] = 'MembershipID';

// Type of key field (int/real/string/date etc.)
$opts['key_type'] = 'int';

// Sorting field(s)
$opts['sort_field'] = array('MembershipID');
