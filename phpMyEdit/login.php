...
$main_table	= 'Users';
  $main_column	 = 'UserID';
  $join_table	 = 'Permission';
  $join_column	 = 'PermissionCode';
  $join_description = 'PermissionKind';

//$opts['fdd']['PermissionCode']['values']['join']
